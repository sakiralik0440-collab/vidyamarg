      ...
      <div className="bg-white shadow-sm px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-3 items-center">
          ...
          <button
            ...
            className="text-sm bg-yellow-100 text-yellow-700 px-3 py-2 rounded hover:bg-yellow-200 transition"
          >
          ...
          <button
            ...
            className="text-sm bg-orange-100 text-orange-700 px-3 py-2 rounded hover:bg-orange-200 transition disabled:opacity-50"
          >
            {detectionRunning
